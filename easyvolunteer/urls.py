...
urlpatterns = [
    ...
    path('introduce', views.introduce, name='introduce'),            # 소개 페이지 0**********
    path('select', views.select, name='select'),                     # 기관/회원 회원가입 선택 페이지  0000000
    ...
    path('mypage', views.mypage, name='mypage'),                     # 일반  마이페이지 0
    path('organ_mypage', views.organ_mypage, name='organ_mypage'),   # 기관 회원 마이페이지 0*******************************
    path('register', views.register, name='register'),               # 기관에서 봉사 등록 페이지 *폼입력**********************
    path('quest', views.quest, name='quest'),                        # 일반 회원이 봉사 신청 페이지 0*******************
    path('quest_what', views.quest_what, name='quest_what'),         # 일반 회원이 선택한 봉사 설명 페이지 ****************
    ...
    path('modify', views.modify, name='modify'),                     #++ 정보 수정 페이지 *폼입력******************************
